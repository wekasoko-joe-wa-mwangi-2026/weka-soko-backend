...
const adminEscrowsRoutes = require("./routes/admin_escrows");
...
app.uapp.use("/api/chat-violations", chatViolationsRoutes);
app.use("/api/admin/escrows", adminEscrowsRoutes);;
